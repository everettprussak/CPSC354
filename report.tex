...
\begin{verbatim}
           ________Exp________
          /                    \
        Exp1               _____Exp________ 
       /                  /                 \
     Exp2               Exp1                Exp 
      |               /       \           /      \           
    Integer          Exp1     Exp2       Exp1     Exp
      |               |         |       /    \      \
      1             Exp2      Integer Exp1  Exp2    Exp1 
                     |          |      |     |        |
                    Integer     3     Exp2  Integer  Exp2
                     |                 |      |       |
                     2                Integer 5      Integer
                                       |              |
                                       4              6 
...
\noindent\newline\newline
Using the function evalCBN on Interpreter.hs, I got the following:

\begin{verbatim}
evalCBN (EApp (EAbs (Ident "x") (EVar (Ident "x"))) (EApp (EAbs (Ident "y") (EVar (Ident "y"))) 
(EVar (Ident "a")))) =

evalCBN (subst (Ident "x") (EApp (EAbs (Ident "y") (EVar (Ident "y"))) (EVar (Ident "a"))) (EVar (Ident "x"))) =

evalCBN (EAbs (Ident "x") (EApp (EAbs (Ident "y") (EVar (Ident "y"))) (EVar (Ident "a"))))
\end{verbatim}
